# Posted Apr 16 8:06pm

Dear All,

Normally I have this conversation in class on the last of day of classes, but I have been receiving inquiries about this.

The final exam is a comprehensive exam.
You will be allowed to use the formula sheets (combination of the two) as well as the z-table, which will be provided to you for the exam.
You will be allowed to use a calculator.
There will be some T/F and fill in the blanks questions like before.
There will be 4-5 problems depending on how much progress we make with forecasting and how comfortable I feel including that topic on the final exam.
There will be
one problem on deterministic inventory,
one problem on stochastic inventory,
one problem on transportation, and
one problem on logistics or supply chain design.
if forecasting is included there can be another short problem.
When I get a chance, I will prepare a study guide for transportation, logistics, and supply chain related material as well.
Warm regards,
...
A take-home portion for the final exam
Dear All,
